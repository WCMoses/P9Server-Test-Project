...
<ComVisible(True)>
<ProgId(“ASCOM.P9.Telescope”)>
<ServedClassName(“P9 Driver”)>
Public Class Telescope
    ...
    '
    Friend Shared driverID As String = "ASCOM.P9.Telescope"
    Friend Shared driverDescription As String = "P9 Driver"
    ...
    Friend Shared RateOffsetDefalut As String = Convert.ToString(0.000)
    ...
    Private minSlewRate As Int32 = 105     'Set to greater than 2x Sidereal Rate in motor counts/second
    ...
    Private s_csDriverID As String
    '
    ...
    Public Sub New()
        ...
        TL = SharedResources.SharedLogger ' New TraceLogger("", "P9")
...
#Region "Common properties and methods"
    ...
    Private Function VerifySerialComml() As Boolean
        ...
        Try
            objSerial = SharedResources.SharedSerial ' New ASCOM.Utilities.Serial
    ...
    Public Property Connected() As Boolean Implements ITelescopeV3.Connected
        ...
        Set(value As Boolean)
            ...
            If value Then
                ...
                If Not WirelessEnabled Then
                    Try
                        objSerial = SharedResources.SharedSerial
                        TL.LogMessage("Connected Set", "Connecting to port " + comPort)
                        If Len(comPort) = 4 Then
                            objSerial.Port = Right(comPort, 1)
                        ElseIf Len(comPort) = 5 Then
...
#Region "ITelescope Implementation"
    ...
    Public Sub SlewToTarget() Implements ITelescopeV3.SlewToTarget
        ...
        'Dim Base_Offset_Ratio As Double
        Dim North_Offset_Ratio As Double
        Dim South_Offset_Ratio As Double

        RATime_offset = 0
        DECTime_offset = 0
        North_Offset_Ratio = 0.002#
        South_Offset_Ratio = 0.000#
        'Offset_Ratio = 0.004#
        Offset_Ratio = 0
        ...
        Try
            If IsConnected Then
                ...
                If Not AtPark Then
                    ...
                    End If
                    If Telescope.SiteLatitudeValue >= 0 Then
                        Offset_Ratio = North_Offset_Ratio
                    ElseIf Telescope.SiteLatitudeValue < 0 Then
                        Offset_Ratio = South_Offset_Ratio
                    End If
